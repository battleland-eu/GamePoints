...
public class StoreConfirmation extends AbstractMenu<GamePoints> {
    ...
    public StoreConfirmation(@NotNull GamePoints plugin) {
    ...
    public void onItemPrepare(@NotNull Player player, @NotNull IMenuItem menuItem, @NotNull ItemStack item) {
        ...
        ItemUT.replace(item, str -> product.replacePlaceholders().apply(str
                .replace(IPointProduct.PLACEHOLDER_PRICE_INHERITED, String.valueOf(user.getInheritedPriceForItem(product)))
        ));
        ItemUT.replace(item, Config.replacePlaceholders());
    }
