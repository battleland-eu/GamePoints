...
public class Config extends IConfigTemplate {
    ...
    public void load() {
        String path = "General.";
        POINTS_NAME = StringUT.color(cfg.getString(path + "Points_Name", "Game Points"));
        ...
        path = "Store.Product.";
        STORE_PRODUCT_DISPLAY_FORMAT = StringUT.color(cfg.getStringList(path + "Display.Format"));
        STORE_PRODUCT_PURCHASE_FORMAT_ALREADY_HAVE = StringUT.color(cfg.getStringList(path + "Purchase.Format.Already_Have"));
        STORE_PRODUCT_PURCHASE_FORMAT_COOLDOWN = StringUT.color(cfg.getStringList(path + "Purchase.Format.Cooldown"));
        STORE_PRODUCT_PURCHASE_FORMAT_AVAILABLE = StringUT.color(cfg.getStringList(path + "Purchase.Format.Available"));
